...
public class JiggleBone : MonoBehaviour {
	...
	Vector3 realDynamicPos = new Vector3();
	Vector3 dynamicPos { get { return CenterOrigin.VirtualToWorld(realDynamicPos);} set { realDynamicPos = CenterOrigin.WorldToVirtual(value);} }
 
	// Bone settings
	public Vector3 boneAxis = new Vector3(0,0,1);
	public float targetDistance = 2000.0f;
